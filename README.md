...
```sh
  cd my-folder
  git clone git@github.com:Al-Amin-Khan-Shakil/math-magicians.git
```
...
Feel free to check the [issues page](https://github.com/Al-Amin-Khan-Shakil/math-magicians/issues).
...
I would like to thank Microverse to provide resources for this project.
...
- **What knowledge Should I have to create a project like this?**
  ...
  - You should have basic HTML, CSS, JavaScript, and React.js Knowledge.
